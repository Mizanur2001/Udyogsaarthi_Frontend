      ...
      <div className="container px-6 py-24 mx-auto lg:py-32">
        <div className="lg:flex">
          <div className="lg:w-1/2">
            <h1 className="mb-3 text-gray-600 dark:text-gray-300 md:text-lg">
              Welcome to,
            </h1>
            <img src={logo} className="w-auto h-10" />

            <h1 className="mt-5 text-2xl font-medium text-gray-800 capitalize lg:text-3xl dark:text-white">
              Register Yourself
            </h1>
          </div>

          <div className="mt-8 lg:w-1/2 lg:mt-0">
            <h1 className="mb-4 text-lg font-medium text-gray-800 capitalize lg:text-xl dark:text-white">
              {showResumeSection
            ...
            <form className="w-full lg:max-w-xl">
              {showResumeSection ? (
                <>
                  ...
                  <label
                    for="dropzone-file"
                    class="flex items-center justify-center h-36 px-3 py-3 mx-auto mt-6 text-center bg-white border-2 border-dashed rounded-lg cursor-pointer dark:border-gray-600 dark:bg-gray-900"
                  >
                    <svg
